...
url='https://raw.githubusercontent.com/DuaneIndustries/DCOschedule/main/DCO_2025_Calendar_v1.csv'
...
def update_gantt(all_rows_data, slctd_row_indices, slct_rows_names, slctd_rows,
    ...
    fig = dcc.Graph(id='gantt-chart', figure=px.timeline(
            ...
            color='Project',
            hover_name='Project',
            hover_data={'Crew':True,'Project':False,'Pattern':False,'Completion PCT':True,'Task':True},
